 ...
 */
public class ButtonFragment extends Fragment implements AboutFragment.OnFragmentInteractionListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Find the +1 button
        mPlusOneButton = (PlusOneButton) view.findViewById(R.id.fragment_button);
